<?php
	$name = 'Эля'; //строчка
    $profession = 'стажер'; //строчка
    $location = 'Москва, Россия'; //строчка
    $email = 'email@email.com'; //строчка
    $phone = '89104568808'; //строчка
    
        // Формировать массив навыков с уровнем владения в процентах
    $skills = [
    	'skill_name' => ['Python', 'Java', 'C#', 'SQL'],
        'level' => [97, 25, 97, 100]
    ];

		// формируем массив c опытом работы
$job = [
'job_name' => ['Канал Москвы', 'УЭМК', 'Школа 83'],
'job_data' => ['2005 - настоящее время', '2001 - 2005', '1998 - 2001'],
'job_desc' => ['Много интересной работы, слишком долго там работаю', 'Получила много знаний и прочных связей', 'Скучновато было, но что делать']
];   
